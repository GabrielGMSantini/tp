...
function send() {//realiza as verificações necessárias
    ...
    if (emtel && levels && document.formulario.estadocivil.value != "Selecione o estado civil" && document.formulario.nome.value.length > 3 && document.formulario.Objetivo.value != "" && CEPval && stateval && document.formulario.City != "") {
